...
In order to see quotas for the different plans on Umbraco Cloud see [Umbraco Cloud Plans](../Umbraco-Cloud/Getting-Started/Umbraco-cloud-plans/)
...
:::note If you have questions about how many resources your site is using, then please reach out to our friendly support team. :::
...
Haven't found an answer to your question? Many security related questions are answered in the [Security section](../Umbraco-Cloud/Security/) of the documentation.
...
Learn more about how to use your own certificates in the [Custom certificates](../Umbraco-Cloud/Set-up/Manage-Hostnames/Security-certificates/) article.
...
You can learn much more about this in our [Security section](../Umbraco-Cloud/Security/#cookies-and-security).
...
Learn more about this and how to set it up in our [Security section](../Umbraco-Cloud/Security/#restrict-backoffice-access-using-ip-filtering).
...
You can read much more about these deletions in the [Deploying Deletions](../Umbraco-Cloud/Deployment/Deploying-Deletions/) article.
...
You can read more about database backups and how to perform these on Umbraco Cloud in the [Databases/Backups section](../Umbraco-Cloud/Databases/Backups/)
