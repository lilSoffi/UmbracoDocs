...
You can [learn more about quotas](../../Umbraco-Cloud/Getting-Started/Umbraco-cloud-plans/) that are put in place to ensure the stability of your website.
...
To start working with and building your site, you can either work directly in the backoffice on the Cloud environment or you can [clone down the project to your local machine](../../Umbraco-Cloud/Set-Up/Working-Locally/). For Mac users, see [Working with Mac](../../Umbraco-Cloud/Set-Up/Working-With-UaaS-Cli/).
...
2. Click **Create New Project**. ![Create new Project](../../Umbraco-Cloud/Getting-Started/images/Create-Project.png)
...
To rename the project file and folder, see the [Renaming the Project file and folder](../../Umbraco-Cloud/Set-up/project-settings/index.md#renaming-the-project-file-and-folder) article.
...
You might not always want to start your Umbraco Cloud project with a clean slate. Perhaps you have an already existing site that you want to move on to the Cloud. For this purpose, we've created a [Migration guide](../../Umbraco-Cloud/Getting-Started/Migrate-Existing-Site/) that you can follow to successfully move your project to Umbraco Cloud.

If you are creating several similar projects, we have a feature called [Baselines](../../Umbraco-Cloud/Getting-Started/Baselines/) that lets you create new projects based on existing Umbraco Cloud projects.
